...
public class SrLeaves extends BlockLeavesBase implements IShearable
{
    private int field_94394_cP;
    int[] adjacentTreeBlocks;

    public SrLeaves(int par1)
    {
...
/**       int j2 = par1IBlockAccess.getBiomeGenForCoords(par2 + i2, par4 + l1).getBiomeFoliageColor();
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (par1World.canLightningStrikeAt(par2, par3 + 1, par4) && !par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && par5Random.nextInt(15) == 1)
        {
            ...
            for (int l = 0; l < 4; ++l)
            {
                double d00 = (double)((float)par2 + par5Random.nextFloat());
                double d11 = (double)((float)par3 + par5Random.nextFloat());
                double d22 = (double)((float)par4 + par5Random.nextFloat());
                double d3 = 0.0D;
                double d4 = 0.0D;
                double d5 = 0.0D;
    ...
    /**
     * returns a list of blocks with the same ID, but different meta (eg:  returns 4 blocks)
     */
