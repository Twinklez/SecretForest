...
public class EntityLamb extends EntityAnimal implements IShearable
{
    ...
    public EntityLamb(World par1World)
    {
        super(par1World);
    ...
    public EntityLamb func_90015_b(EntityAgeable par1EntityAgeable)
    {
        EntityLamb entityLamb = (EntityLamb)par1EntityAgeable;
        EntityLamb entityLamb1 = new EntityLamb(this.worldObj);
        return entityLamb1;
    }
    ...
    {
        return 15 - ((EntityLamb)par1EntityAnimal).getFleeceColor();
    }
